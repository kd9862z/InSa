...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.CustomViewHolder> {
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public CustomViewHolder(View view) {
            super(view);
            this.id = (TextView) view.findViewById(R.id.item_list);
            this.english = (TextView) view.findViewById(R.id.item_list_english);
            this.korean = (TextView) view.findViewById(R.id.item_list_korean);
        }
    }
